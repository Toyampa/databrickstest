...
# MAGIC wget -O /dbfs/data/products.csv https://raw.githubusercontent.com/MicrosoftLearning/mslearn-databricks/main/Allfiles/Labs/03/data/products.csv
...
# MAGIC %md
# MAGIC The file data in Delta format can be loaded into a **DeltaTable** object, which you can use to view and upodate the data in the table. Run the following cell to update the data; reducing the price of product 771 by 10%.
...
# MAGIC wget -O /dbfs/device_stream/devices1.json https://raw.githubusercontent.com/MicrosoftLearning/mslearn-databricks/main/Allfiles/Labs/03/data/devices1.json
...
# MAGIC %sh
# MAGIC wget -O /dbfs/device_stream/devices2.json https://raw.githubusercontent.com/MicrosoftLearning/mslearn-databricks/main/Allfiles/Labs/03/data/devices2.json
